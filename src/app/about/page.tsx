    ...
    <div className='bg-gray-50 min-h-screen'>
      ...
      <section className='bg-white py-8 px-6 sm:px-12 md:px-20 flex flex-col items-center text-center'>
        ...
        <p className='max-w-3xl text-gray-700 text-lg sm:text-xl leading-relaxed'>
          ...
          to create the Durga Puja Pandals Map — making cultural events more
          accessible and interactive. Our contributors bring expertise in
          full-stack development, UI/UX design, and data visualization.
        </p>
      </section>
        ...
        <div className='flex flex-wrap justify-center gap-8'>
          {contributors.map(c => (
            ...
            >
              ...
              {c.bio && <p className='text-gray-600 text-sm mt-2'>{c.bio}</p>}
              {c.linkedin && (
                <a
                  href={c.linkedin}
                  target='_blank'
      ...
      <section className='text-center py-12 bg-gray-100'>
        <p className='text-gray-500 text-sm'>
          &copy; {new Date().getFullYear()} Durga Puja Pandals Map. All rights
          reserved.
        </p>
      </section>
    </div>
